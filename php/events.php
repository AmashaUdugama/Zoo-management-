...
/* For devices with a max-width of 480px (Mobile) */
...
<header>
    ...
    <section class="hero">
        <img src="..\img\eventtop.png" alt="event" width="100%" height="500">
        <div class="hero-text">
            <h1>Welcome to Event</h1>
            <p>Enjoy With Us ! Find out your happiness engaging with events.</p>
        </div>
    </section> 
    ...
    <div class="event-list">
        ...
        <div class="event">
            ...
            <img src="<?php echo htmlspecialchars($event['picture']); ?>" alt="Event Picture">
            <div class="details">
            <h2><?php echo htmlspecialchars($event['name']); ?></h2>
           <div> <p><?php echo htmlspecialchars($event['description']); ?></p>
            <p><?php echo htmlspecialchars($event['details']); ?></p></div></div>
        </div>
        <?php } ?>
    </div>
    <footer>
