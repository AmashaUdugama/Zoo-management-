...
<header>
    ...
    <section class="hero">
        <img src="..\img\animaltop.png" alt="ZooParc Entrance" width="100%" height="500">
        <div class="hero-text">
            <h1>Welcome to Animals gallery</h1>
            <p>Start your adventure ! Find out everything you need to know about animals.</p>
        </div>
    </section>   
    ...
    <div class="animal-list">
        ...
        <div class="animal">
            ...
            <img src="<?php echo htmlspecialchars($animal['picture']); ?>" alt="Animal Picture">
            <div class="details">

            
            <h2><?php echo htmlspecialchars($animal['name']); ?></h2>
           <div> <p><?php echo htmlspecialchars($animal['description']); ?></p>
            <p><?php echo htmlspecialchars($animal['details']); ?></p></div></div>
        </div>
        <?php } ?>
    </div>
    <footer>
